namespace BackChurch.Data.Queries
{
    public class MembrosQueries
    {
        ...
        private string InserirUmMembro()
        {
            return $@"
                INSERT INTO Membros
                (Cod_Membro, Nome, Data_Nascimento, Email, CPF, CNPJ, Telefone, Estado_Civil, Id_Endereco, Id_Historico, Id_Igreja)
                VALUES
                (@CodMembro, @Nome, @DataNascimento, @Email, @CPF, @CNPJ, @Telefone, @EstadoCivil, @IdEndereco, @IdHistorico, @IdIgreja)";
        }
